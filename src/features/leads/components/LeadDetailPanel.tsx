...
import { X, Calendar, User, AlignLeft, Send, Loader2, FileText } from "lucide-react";
            ...
            <div className="w-full max-w-md bg-gray-950 border-l border-gray-800 h-full flex flex-col shadow-2xl animate-in slide-in-from-right duration-300">
                ...
                <div className="flex border-b border-gray-800 bg-gray-900 px-6">
                    <button
                        ...
                        className={`py-3 px-4 flex items-center gap-2 border-b-2 transition-colors ${activeTab === "details" ? "border-blue-500 text-blue-400 font-medium" : "border-transparent text-gray-400 hover:text-gray-300"}`}
                    >
                    ...
                    <button
                        ...
                        className={`py-3 px-4 flex items-center gap-2 border-b-2 transition-colors ${activeTab === "quotation" ? "border-blue-500 text-blue-400 font-medium" : "border-transparent text-gray-400 hover:text-gray-300"}`}
                    >
